    ...
    def handle(self):
        ...
        if s[0] == "execute":
            if s[1] == "worker":
                ...
                cmd = "sudo -E " + cmd + "DMLC_ROLE=worker DMLC_NUM_SERVER=1  DMLC_INTERFACE=enp178s0f0 DMLC_PS_ROOT_URI=192.168.0.3 DMLC_PS_ROOT_PORT=6767 python ../launcher/launch.py python ../example/pytorch/benchmark_byteps.py --model " + model + " --num-iters " + iter_num
                print(cmd)
